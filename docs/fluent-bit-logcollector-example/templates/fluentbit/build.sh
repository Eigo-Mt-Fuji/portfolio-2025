...
# Build image
docker build -t 047980477351.dkr.ecr.ap-northeast-1.amazonaws.com/${ENV}-fluentbit:latest .

# Push image
docker push 047980477351.dkr.ecr.ap-northeast-1.amazonaws.com/${ENV}-fluentbit:latest
